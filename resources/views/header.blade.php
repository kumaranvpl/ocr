<head>
        ...
        <link href="{{ URL::asset('assets/libs/prettify/github.css') }}" rel="stylesheet" />
                ...
                <link href="{{ URL::asset('assets/libs/morrischart/morris.css') }}" rel="stylesheet" type="text/css" />
                <link href="{{ URL::asset('assets/libs/jquery-jvectormap/css/jquery-jvectormap-1.2.2.css') }}" rel="stylesheet" type="text/css" />
                <link href="{{ URL::asset('assets/libs/jquery-clock/clock.css') }}" rel="stylesheet" type="text/css" />
                <link href="{{ URL::asset('assets/libs/bootstrap-calendar/css/bic_calendar.css') }}" rel="stylesheet" type="text/css" />
                <link href="{{ URL::asset('assets/libs/sortable/sortable-theme-bootstrap.css') }}" rel="stylesheet" type="text/css" />
                <link href="{{ URL::asset('assets/libs/jquery-weather/simpleweather.css') }}" rel="stylesheet" type="text/css" />
                <link href="{{ URL::asset('assets/libs/bootstrap-xeditable/css/bootstrap-editable.css') }}" rel="stylesheet" type="text/css" />
        ...
        <link rel="shortcut icon" href="http://www.1000lookz.com/lib/img/logo.png">
        <link rel="apple-touch-icon" href="http://www.1000lookz.com/lib/img/logo.png" />
        <link rel="apple-touch-icon" sizes="57x57" href="http://www.1000lookz.com/lib/img/logo.png" />
        <link rel="apple-touch-icon" sizes="72x72" href="http://www.1000lookz.com/lib/img/logo.png" />
        <link rel="apple-touch-icon" sizes="76x76" href="http://www.1000lookz.com/lib/img/logo.png" />
        <link rel="apple-touch-icon" sizes="114x114" href="http://www.1000lookz.com/lib/img/logo.png" />
        <link rel="apple-touch-icon" sizes="120x120" href="http://www.1000lookz.com/lib/img/logo.png" />
