...
<script src="{{ URL::asset('assets/libs/d3/d3.v3.js') }}"></script>
...
<script src="{{ URL::asset('assets/libs/morrischart/morris.min.js') }}"></script>
<script src="{{ URL::asset('assets/libs/jquery-knob/jquery.knob.js') }}"></script>
<script src="{{ URL::asset('assets/libs/jquery-jvectormap/js/jquery-jvectormap-1.2.2.min.js') }}"></script>
<script src="{{ URL::asset('assets/libs/jquery-jvectormap/js/jquery-jvectormap-us-aea-en.js') }}"></script>
<script src="{{ URL::asset('assets/libs/jquery-clock/clock.js') }}"></script>
<script src="{{ URL::asset('assets/libs/jquery-easypiechart/jquery.easypiechart.min.js') }}"></script>
<script src="{{ URL::asset('assets/libs/jquery-weather/jquery.simpleWeather-2.6.min.js') }}"></script>
<script src="{{ URL::asset('assets/libs/bootstrap-xeditable/js/bootstrap-editable.min.js') }}"></script>
